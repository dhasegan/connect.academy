...
EMAIL_HOST_USER = environ.get('ACADEMY_EMAIL_HOST_USER', 'noreply@connect.academy')
EMAIL_HOST_PASSWORD = environ.get('ACADEMY_EMAIL_HOST_PASSWORD', 'theotherside01')
...
AWS_STORAGE_BUCKET_NAME = environ.get('ACADEMY_AWS_BUCKET', '')
