...
urlpatterns = patterns('app.profile.views',
    url(r'^profile/(?P<username>[A-Za-z0-9\._-]{3,25})/$', 'profile', name='profile'),
    ...
    url(r'^profile/(?P<username>[A-Za-z0-9\._-]{3,25})/load_profile_activities$', 'load_profile_activities', name='load_profile_activities'),
    url(r'^profile/(?P<username>[A-Za-z0-9\._-]{3,25})/load_new_profile_activities$', 'load_new_profile_activities', name='load_new_profile_activities'),
